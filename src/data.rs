...
impl GameField {
    pub fn get_from_game<'a>(&self, game: &'a Game) -> Cow<'a, str> {
        match self {
            ...
            GameField::PathHero => display_opt_path(game.path_hero.as_ref()).into(),
            GameField::PathHeader => display_opt_path(game.path_header.as_ref()).into(),
...
mod test {
    ...
    fn gamefield_from_game() {
        let game = Game {
            ...
            path_hero: Some(PathBuf::from("/home/rolv")),
            path_header: Some(PathBuf::from("/home/rolv")),
        ...
        let game = Game {
            ...
            path_hero: Some(PathBuf::from("/")),
            path_header: Some(PathBuf::from("/")),
